...
// uniform data accessed in Metal shaders matches the layout of uniform data set in C code
typedef struct {
    // Camera Uniforms
...
// Structure shared between shader and C code to ensure the layout of instance
// uniform data accessed in Metal shaders matches the layout of uniform data set in C code
typedef struct {
